...
#>
	...
	$ConsumerTemplate = @(
		'New WMI Consumer Created;Consumer Name: %TargetInstance.Name%;Command Executed: %TargetInstance.ExecutablePath%'
	)

	$ProcessCallTemplate = @(
		'WMI Command Executed;Namespace: %Namespace%;Method Executed: %MethodName%;Command Executed: %InputParameters.CommandLine%'
	)
